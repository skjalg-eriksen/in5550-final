...
class MLP_classifier(nn.Module):
    def __init__(self, token_vocab, tag_vocab, encoder, hidden_size=512, dropout=0):
        super().__init__()
...
# hierarchical convnet architecture
    def __init__(self, token_vocab, filter_size=256):
        super().__init__()
...
# structured self-attentive sentence embedding architecture, paper: https://arxiv.org/pdf/1703.03130.pdf
    def __init__(self, token_vocab, hidden_size=1024, attention_dim=256, attention_hops=4):
        super().__init__()
